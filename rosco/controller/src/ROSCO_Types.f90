...
TYPE, PUBLIC :: ControlParameters
    ...
    INTEGER(IntKi)                :: PPPR_Mode                   ! Platform Pitch Proportional Resonance control mode [0 - unused, 1 - Active]
    ...
    REAL(DbKi) :: PPPR_freq_phi               ! Desired forcing frequency for platform pitch [rad/s]
    REAL(DbKi) :: PPPR_freq_omega             ! Desired forcing frequency for generator speed [rad/s]
    REAL(DbKi) :: PPPR_amp_phi                ! Amplitude for platform pitch input [deg or rad]
    REAL(DbKi) :: PPPR_amp_omega              ! Amplitude for generator speed input [rad/s]
    REAL(DbKi), DIMENSION(:), ALLOCATABLE     :: PPPR_CntrGains_phi          ! PR gains [Kp, Kr] for platform pitch
    REAL(DbKi), DIMENSION(:), ALLOCATABLE     :: PPPR_CntrGains_omega        ! PR gains [Kp, Kr] for generator speed
    REAL(DbKi)                    :: Phi_phaseoffset             ! Phi Waveform Phase Offset [deg]
    REAL(DbKi)                    :: Omega_phaseoffset             ! Omega Waveform Phase Offset [deg]
...
TYPE, PUBLIC :: ObjectInstances
    ...
    INTEGER(IntKi)                :: instRes_phi                 ! Phi_PR controller instance
    INTEGER(IntKi)                :: instRes_tau                 ! Tau_PR controller instance
